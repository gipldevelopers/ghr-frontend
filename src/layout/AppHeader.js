      ...
      <div className="flex flex-col items-center justify-between w-full lg:flex-row lg:px-6">
        ...
        <div className="flex items-center justify-between w-full gap-2 px-4 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button
            ...
            className={`lg:hidden flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors ${isSearchVisible ? 'hidden' : 'flex'}`}
            aria-label="Search"
          >
            <svg
              width="20"
          ...
          <div className={`search-container lg:hidden w-full ${isSearchVisible ? 'block' : 'hidden'}`}>
            <div className="relative">
              ...
              <input
                ...
                type="text"
                placeholder="Search..."
                className="w-full h-10 rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-2 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                autoFocus
              />
              <button
                onClick={toggleSearch}
                className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
          ...
          <div className={`hidden md:block lg:ml-4 ${isSearchVisible ? 'hidden' : 'block'}`}>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {loading ? "Loading..." : `Welcome back, ${user?.employee?.firstName || user?.email}`}
            </p>
          </div>
          ...
          <button
            ...
            className={`flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden ${isSearchVisible ? 'hidden' : 'flex'}`}
            ...
            <form className="search-container">
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-dark-900 h-11 rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 w-full sm:w-64 md:w-80 xl:w-[430px]"
                />
        ...
        >
          ...
          <div className="md:hidden">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {loading ? "Loading..." : `Welcome, ${user?.employee?.firstName || user?.email}`}
            </p>
          </div>
