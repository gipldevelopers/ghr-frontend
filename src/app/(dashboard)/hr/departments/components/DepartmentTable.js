...
//     id: 3,
//     name: 'Finance',
//     headOfDepartment: 'Lori Broaddus',
//     phone: '(168) 8392 823',
...
//     id: 6,
//     name: 'Operations',
//     headOfDepartment: 'Amanda Taylor',
//     phone: '(168) 8392 831',
...
//     headOfDepartment: 'Christopher Anderson',
//     phone: '(168) 8392 832',
...
//     headOfDepartment: 'Jessica Martinez',
//     phone: '(168) 8392 833',
...
//     headOfDepartment: 'Daniel Thomas',
//     phone: '(168) 8392 834',
...
//         department.headOfDepartment.toLowerCase().includes(searchTerm) ||
//         department.email.toLowerCase().includes(searchTerm) ||
//         department.phone.toLowerCase().includes(searchTerm)
//       );
//     }
    
//     // Apply status filter
//     if (statusFilter !== 'all') {
//       result = result.filter(department => department.status === statusFilter);
//     }
...
//     const uniqueStatuses = new Set(data.map(dept => dept.status));
...
//       setData(data.filter(dept => dept.id !== department.id));
//     }
//   };
...
//         Showing {filteredData.length} of {defaultData.length} departments
