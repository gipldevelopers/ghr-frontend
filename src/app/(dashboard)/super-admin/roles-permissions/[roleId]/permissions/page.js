...
//   //         setRole({
//   //           ...response.data,
//   //           createdDate: new Date(response.data.createdAt).toLocaleDateString('en-GB', {
//   //             day: '2-digit',
//   //             month: 'short',
//   //             year: 'numeric'
//   //           }),
//   //           status: response.data.status.charAt(0) + response.data.status.slice(1).toLowerCase()
//   //         });
//   //       }
//   //     } catch (error) {
...
//           const response = await roleService.getRoleById(params.roleId);
//           if (response.success) {
//             // FIX: Handle system roles that don't have 'status' field
//             const roleData = response.data;
//             let status = 'Active';
            
//             // Check if it's a system role
//             if (roleData.isSystem === true || roleData.isEditable !== undefined) {
...
//         <div className="bg-white rounded-lg shadow dark:bg-gray-800">
//           <PermissionManager roleId={params.roleId} roleName={role?.name} isSystem={isSystemRole}  />
//         </div>
//       </div>
//     </div>
//   );
